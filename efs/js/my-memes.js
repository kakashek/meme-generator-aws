document.addEventListener('DOMContentLoaded', function() {
    ...
    function appendMemeToContainer(imageUrl, meme, container) {
        ...
        col.innerHTML = `
            <div class="card" id="card-${meme.memeId}">
                ...
                <div class="card-body">
                    ...
                    <button id="download-${meme.memeId}" class="btn btn-primary">Download</button>
        ...
        document.getElementById(`download-${meme.memeId}`).addEventListener('click', function() {
            downloadMeme(meme.memeId);  
        });
    ...
    // Function to handle downloading memes
    function downloadMeme(memeId) {
        const imageUrl = document.getElementById(`meme-img-${memeId}`).src;
